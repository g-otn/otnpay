/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 938591016d8480757fb59eb2110be365)
// Runtime types generated with workerd@1.20260305.0 2026-02-19 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
  }
  interface DevDockerEnv {
    AUTH_SERVICE_DB_URL: string;
    AUTH_SERVICE_REDIS_URL: string;
    AUTH_SERVICE_REDIS_TOKEN: string;
    AUTH_SERVICE_JWT_SECRET: string;
    AUTH_SERVICE_JWT_PUBLIC_KEY: string;
  }
  interface Env {
    AUTH_SERVICE_DB_URL: string;
    AUTH_SERVICE_REDIS_URL: string;
  ...
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        ...
        | 'AUTH_SERVICE_REDIS_TOKEN'
        | 'AUTH_SERVICE_JWT_SECRET'
        | 'AUTH_SERVICE_JWT_PUBLIC_KEY'
      >
    > {}
}
