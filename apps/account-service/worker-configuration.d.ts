/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f68deb5fc4f8d3bef7ca0080a234df35)
...
declare namespace Cloudflare {
  ...
  interface DevDockerEnv {
    ...
    ACCOUNT_SERVICE_DB_URL: string;
    ACCOUNT_SERVICE_JWT_PUBLIC_KEY: string;
  }
  interface Env {
    ACCOUNT_SERVICE_DB_URL: string;
    ACCOUNT_SERVICE_JWT_PUBLIC_KEY: string;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'ACCOUNT_SERVICE_DB_URL' | 'ACCOUNT_SERVICE_JWT_PUBLIC_KEY'
      >
    > {}
}
